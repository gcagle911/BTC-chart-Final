// Simplified Cardano (ADA) Chart - Clean Interface
...
class TimeframeManager {
  ...
  async initializeChart() {
    try {
      ...
      const recentRes = await fetch('https://ada-logger.onrender.com/recent.json');
      ...
      const historicalRes = await fetch('https://ada-logger.onrender.com/historical.json');
      ...
      // Fallback
      try {
        const fallbackRes = await fetch('https://ada-logger.onrender.com/output-latest.json');
  ...
  async fetchAndUpdate() {
    try {
      const res = await fetch('https://ada-logger.onrender.com/recent.json');
  ...
  async refreshHistoricalData() {
    ...
    try {
      ...
      const res = await fetch('https://ada-logger.onrender.com/historical.json');
      const data = await res.json();
      this.rawData = data;
